...
public class MediaDemo extends Application {
    private static final String MEDIA_URL = "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4";
...
//        HBox hBox = new HBox(10);
//        hBox.setAlignment(Pos.CENTER);
//        hBox.getChildren().addAll(playButton, rewindButton, new Label("Seek")/*, seekSlider*/);
//
//        BorderPane pane = new BorderPane();
//        pane.setBottom(hBox);
//        pane.setCenter(mediaView);
...
//        primaryStage.setScene(new Scene(pane, 650, 500));
//        primaryStage.show();
    }
}
